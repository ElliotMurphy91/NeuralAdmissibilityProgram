...
python test_sims.py      # 26 analytic self-checks, a few seconds
```
...
is evaluated pointwise by grid minimization over 1,201 knots. Six laws are
compared:
...
BETA SWEEP, d=1 rotation @ 0 dB (corrected gate | unnormalised gate)
  beta= 0.03: 0.997 | 0.919
  beta=  0.1: 0.997 | 0.917
  beta=  0.3: 0.997 | 0.900
  beta=  0.5: 0.991 | 0.842
  beta=  1.0: 0.819 | 0.633
  beta=  3.0: 0.532 | 0.504
  beta= 10.0: 0.505 | 0.498
  beta= 30.0: 0.505 | 0.499
