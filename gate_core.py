...
class Laws:
    ...
    def meld(self, u, v):
        ...
        (commutativity), tanh a saturating transfer (boundedness without
        idempotence, pairing recovered at third order).  Reduces to `sat_tied`
        as beta -> 0 and to a saturated tied minimum as beta -> inf."""
...
NAMES = ["gate", "gate_norm", "additive", "tensor", "rnn", "mean_pool", "sat_mean", "sat_tied", "meld"]
